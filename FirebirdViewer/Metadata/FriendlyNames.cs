...
public static class FriendlyNames
{
    ...
    private static readonly Dictionary<string, Dictionary<string, ColumnInfo>> Columns = new(System.StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["REC_COMMON"] = new(System.StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["TABLE_TORQUE"]       = new("Момент ротора",              "у.е.",   "Показания датчика момента на роторе."),
            ["ROTOR_SPEED"]        = new("Обороты ротора",             "об/мин", "Показания датчика оборотов ротора."),
            ["TR_BLOCK_POS"]       = new("Тальблок",                   "м",      "Высота положения крюка над роторным столом."),
            ...
            ["VOLUME1"]            = new("Объём в ёмкости 1",          "м³",     "Объём ПЖ в первой ёмкости."),
            ["VOLUME2"]            = new("Объём в ёмкости 2",          "м³",     "Объём ПЖ во второй ёмкости."),
            ["VOLUME3"]            = new("Объём в ёмкости 3",          "м³",     "Объём ПЖ в третьей ёмкости."),
            ["VOLUME4"]            = new("Объём в ёмкости 4",          "м³",     "Объём ПЖ в четвёртой ёмкости."),
            ["VOLUME5"]            = new("Объём в ёмкости 5",          "м³",     "Объём ПЖ в пятой ёмкости."),
            ["VOLUME6"]            = new("Объём в ёмкости 6",          "м³",     "Объём ПЖ в шестой ёмкости."),
            ["VOLUME7"]            = new("Объём в ёмкости 7",          "м³",     "Объём ПЖ в седьмой ёмкости."),
            ["VOLUME8"]            = new("Объём в ёмкости 8",          "м³",     "Объём ПЖ в восьмой ёмкости."),
            ["VOLUME9"]            = new("Объём в ёмкости 9",          "м³",     "Объём ПЖ в девятой ёмкости."),
            ["VOLUME10"]           = new("Объём в ёмкости 10",         "м³",     "Объём ПЖ в десятой ёмкости."),
            ["VOLUME11"]           = new("Объём в ёмкости 11",         "м³",     "Объём ПЖ в одиннадцатой ёмкости."),
            ["VOLUME12"]           = new("Объём в ёмкости 12",         "м³",     "Объём ПЖ в двенадцатой ёмкости."),
            ["VOLUME13"]           = new("Объём в ёмкости 13",         "м³",     "Объём ПЖ в тринадцатой ёмкости."),
            ["VOLUME14"]           = new("Объём в ёмкости 14",         "м³",     "Объём ПЖ в четырнадцатой ёмкости."),
            ["VOLUME15"]           = new("Объём в ёмкости 15",         "м³",     "Объём ПЖ в пятнадцатой ёмкости."),
            ["VOLUME16"]           = new("Объём в ёмкости 16",         "м³",     "Объём ПЖ в шестнадцатой ёмкости."),
            ["ACTIVE_VOLUME"]      = new("Объём в активных ёмкостях",  "м³",     "Объём раствора в ёмкостях, участвующих в циркуляции."),
            ...
            ["CIRC_RATE_IN"]       = new("Расход на входе",            "л/с",    "Показания датчика расхода на входе."),
            ["CIRC_RATE_OUT"]      = new("Расход на выходе",           "л/с",    "Показания датчика расхода на выходе."),
